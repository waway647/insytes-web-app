...
<div 
    ...
    x-data="{
        ...
        init() {
          ...
          console.log('🟣 [Alpine:init] Add Player modal initialized — teamId=', this.teamId, 'teamName=', this.teamName);
        },
    ...
    x-init="init()"
>
    <form @submit.prevent="submitForm" action="<?php echo site_url('match/modalInsertsController/create_player'); ?>" method="POST">
        <div class="px-5 py-3">
