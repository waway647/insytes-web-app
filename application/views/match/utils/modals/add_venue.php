...
>
    <form @submit.prevent="submitForm" action="<?php echo site_url('match/modalInsertsController/create_venue'); ?>" method="POST">
        <div class="px-5 py-3">
