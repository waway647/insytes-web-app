...
$match_summary = trim((string)($match_summary ?? ''));
...
<div class="w-full flex flex-col gap-6 font-sans antialiased text-slate-200">
    ...
    <div class="w-full flex flex-col gap-4 p-4">
        <p class="text-sm text-white font-semibold">Match Summary</p>
        <div class="w-full p-6 bg-[#1D1D1D] rounded-xl shadow hover:shadow-lg transition flex items-center justify-center">
            <span class="text-md text-gray-400 font-normal break-words"><?= e($match_summary) ?></span>
        </div>
    </div>
