...
<div class="w-full flex flex-col gap-6 font-sans antialiased text-slate-200">
  <div class="w-full p-4">
    <p class="text-xl font-bold text-white"><?= e($overall_assessment ?: ''); ?></p>
  </div>

  <div class="w-full flex flex-col lg:flex-row gap-6 p-4">
    <div class="w-full lg:w-1/2 flex flex-col gap-4 p-4 rounded-2xl bg-gradient-to-b from-[#0d0d0e] to-[#0b0b0b] border border-white/6 shadow-sm">
  ...
  <div class="w-full flex flex-col gap-4 p-4">
    ...
    <div class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      foreach ($metrics_map as $k => $label):
          $val = $key_metrics[$k] ?? '';
      ?>
      <div class="w-full p-5 bg-[#121212] rounded-xl flex flex-col items-center gap-1 border border-white/5 shadow-sm hover:shadow-md transition transform hover:-translate-y-0.5">
        <?php if ($k === 'shooting_accuracy'): ?>
  ...
  <div class="w-full flex flex-col gap-4 p-4">
    ...
    <div class="w-full px-6 py-6 bg-gradient-to-b from-[#101010] to-[#0b0b0b] rounded-2xl border border-white/6 shadow-sm">
