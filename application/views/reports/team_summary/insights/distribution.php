    ...
    <div class="w-full flex flex-col gap-4 p-4">
        ...
        <div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            foreach ($metrics_map as $k => $label):
                $val = $key_metrics[$k] ?? '';
            ?>
            <div class="w-full p-5 bg-[#1D1D1D] rounded-xl flex flex-col items-center gap-2 border border-white/5 shadow-sm hover:shadow-md transition transform hover:-translate-y-0.5">
                <?php if ($k === 'passing_accuracy'): ?>
